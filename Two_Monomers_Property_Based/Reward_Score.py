...
def choose_chemical_groups():
    comapitable_groups = [["C=C", "C=C(C=O)"], ["C=C", "CCS"], ["C1OC1", "NC"], ["C=C", "OH"]]
    return random.sample(comapitable_groups, 1)[0]
...
def get_reaction_score(pred_smiles1, pred_smiles2, chemical_groups):
    ...
    try:
        #chemical_groups = choose_chemical_groups()
