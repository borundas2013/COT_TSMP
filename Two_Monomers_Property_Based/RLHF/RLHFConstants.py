import random
WEIGHT_PATH = "Two_Monomers_Property_Based/RLHF/models/weights"
WEIGHT_PATH_NAME = "best_model.weights.h5"
CONFIG_PATH = "Two_Monomers_Property_Based/RLHF/models/weights"
DATA_PATH = "Two_Monomers_Property_Based/Dataset"

FEEDBACK_COLLECT_EPOCH = 10
PRETRAINED_MODEL_PATH = "Two_Monomers_Property_Based/pretrained_model"
PRETRAINED_MODEL_NAME = "saved_models_rl_gpu_3"
DATA_FILE_NAME = "unique_smiles_Er.xlsx"
GENERATOR_MODEL_NAME = "property_based_rl_model"
GENERATOR_MODEL_PATH = "Two_Monomers_Property_Based/RLHF/Generator/models/"
FEEDBACK_COLLECTOR_PATH = "Two_Monomers_Property_Based/RLHF/FeedbackCollector/feedback_data"
FEEDBACK_COLLECTOR_FILE_NAME = "feedback_data.json"

SCORE_PATH = "Two_Monomers_Property_Based/Data/data_with_score.csv"

GENERATED_MOLECULES_PATH = "Two_Monomers_Property_Based/RLHF/generated_molecules"
GENERATED_MOLECULES_FILE_NAME = "valid_generations.json"


SAMPLES_WITH_REWARD_PATH = "Two_Monomers_Property_Based/RLHF/samples_with_reward"
...
TEST_SAMPLES = [
    {
        ...
        'actual_er': random.randint(100, 200),
        'actual_tg': random.randint(100, 200)
    },
    {
