...
class RelationalGraphConvLayer(keras.layers.Layer):
    ...
    def build(self, input_shape):
        ...
        node_dim = input_shape[0][1]  # node features dimension
        edge_dim = input_shape[1][2]  # edge features dimension
        
        total_dim = node_dim + edge_dim +2
    ...
    def call(self, inputs, training=False):
        ...
        # Combine features
        x = tf.concat([node_features_0, edge_features_0], axis=-1)
        y = tf.concat([node_features_1, edge_features_1], axis=-1)
